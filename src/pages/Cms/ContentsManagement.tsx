...
interface FormBlock {
  ...
  // IMPORTANT:
  // Every block has its own image array.
  imageFiles: File[];
        ...
        <div>
          ...
          <input
            ...
            onChange={(
              ...
              /*
               * IMPORTANT:
               * These files are added ONLY to this block.
               *
               * Block 0 -> blocks[0].imageFiles
               * Block 1 -> blocks[1].imageFiles
               * Block 2 -> blocks[2].imageFiles
               */
          ...
          <button
            ...
            className="flex min-h-[80px] w-full items-center justify-center gap-3 rounded-xl border border-dashed border-[#b8902e]/30 bg-white px-4 text-xs font-semibold text-[#8f6d1d] transition hover:border-[#b8902e]/50 hover:bg-[#fffdf8]"
          >
            <FiUpload
              size={18}
            />
            ...
            <div className="text-left">
              ...
              <p className="mt-0.5 text-[9px] font-normal text-[#a19583]">
                  ...
                  (
                    ...
                    >
                      ...
                      <button
                        ...
                        className="absolute right-2 top-2 flex h-7 w-7 items-center justify-center rounded-full bg-black/65 text-white opacity-100 shadow-lg transition hover:bg-[#b46055]"
                        title="Remove image"
                      >
                        <FiX
                          size={13}
          ...
          {(block.imageFiles
            ...
            block.existingImages
              .length > 0) && (
            <div className="mt-3 rounded-xl border border-[#b8902e]/10 bg-[#faf8f3] px-3 py-2.5">
              <p className="text-[9px] leading-4 text-[#786f60]">
              ...
              <p className="mt-1 font-mono text-[8px] leading-4 text-[#9b907e]">
                blocks[
                {index}
                ][images][0],
                blocks[
...
> = ({
  ...
  return (
    <div className="group relative aspect-video overflow-hidden rounded-xl border border-[#b8902e]/20 bg-white">
      <img
        src={previewUrl}
        alt={file.name}
        className="h-full w-full object-cover"
      ...
      <button
        type="button"
        onClick={onRemove}
        className="absolute right-2 top-2 flex h-7 w-7 items-center justify-center rounded-full bg-black/70 text-white shadow-lg transition hover:bg-[#b46055]"
        title="Remove image"
      >
        <FiX size={13} />
      </button>

      <span className="absolute left-2 top-2 rounded-full bg-[#b8902e] px-2 py-1 text-[7px] font-bold uppercase text-white">
        New
      </span>
    </div>
  );
...
> = ({
  ...
  return (
    <GlobalModal
      ...
      closeOnOverlayClick
    >
      <div className="w-full max-w-[1000px] overflow-hidden rounded-[22px] border border-[#b8902e]/15 bg-white shadow-2xl">
...
> = ({
        ...
        (
          ...
          .map(
            (
              ...
              /*
               * IMPORTANT:
               * Existing images remain inside the same block.
               */
              existingImages:
                (block.images ||
                  []
  ...
  const handleSubmit = (
     ...
     * IMPORTANT:
     *
     * Every block is mapped independently.
     *
     * block 0 image files -> block.imageFiles of index 0
     * block 1 image files -> block.imageFiles of index 1
     *
     * We DO NOT combine all files into one global array.
     */
  ...
  return (
    ...
    >
      <div className="w-full max-w-[980px] overflow-hidden rounded-[22px] border border-[#b8902e]/15 bg-white shadow-2xl">
        {/* TOP LINE */}
        ...
        <div className="flex items-start justify-between gap-4 border-b border-[#b8902e]/10 bg-white px-5 py-5 sm:px-6">
          <div className="flex min-w-0 items-center gap-3">
            ...
            <div className="min-w-0">
              ...
              <h2 className="mt-0.5 truncate text-[20px] font-bold text-[#29251f]">
                {mode ===
                "add"
                  ? "Add Page"
                  : "Edit Page"}
          ...
          <button
            ...
            className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-[#faf8f3] text-[#8f6d1d] transition hover:bg-[#f2ead8] disabled:opacity-50"
          >
            <FiX size={18} />
          </button>
        </div>
        ...
        >
          <div className="max-h-[75vh] overflow-y-auto bg-[#fffdfa] p-5 sm:p-6">
            {/* =================================================
                BASIC INFO
            ================================================= */}
            ...
            <div className="mt-5">
              <div className="mb-3 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <button
                  ...
                  className="flex h-9 items-center justify-center gap-2 rounded-xl border border-[#b8902e]/20 bg-[#fffaf0] px-3.5 text-[10px] font-bold text-[#8f6d1d] transition hover:bg-[#b8902e] hover:text-white"
                >
                  <FiPlus
                    size={14}
                  />
...
const ContentsManagement: React.FC =
  () => {
    ...
    const openEdit = (
      ...
      /*
       * Important:
       * Pass COMPLETE page object into modal.
       * Modal itself maps every block + image.
       */
