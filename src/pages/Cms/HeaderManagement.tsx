...
const HeaderManagement: React.FC =
  () => {
    ...
    const [editingMenu, setEditingMenu] =
      useState<HeaderMenu | null>(null);

    const [savingMenu, setSavingMenu] =
      useState(false);

    const [brandingModalOpen, setBrandingModalOpen] =
      useState(false);
          ...
          >
            <div>
              ...
              <p className="mt-1 max-w-2xl text-xs leading-5 text-[#8d8372]">
                Manage your permanent Home
                header, website branding and
                navigation menus.
              </p>
            </div>
          ...
          >
            ...
            <div className="border-b border-[#b8902e]/10 p-4">
              ...
              <div className="mt-3 flex flex-wrap gap-2">
                ...
                <span className="rounded-full border border-red-200 bg-red-50 px-3 py-1.5 text-[9px] font-bold text-red-600">
                  Disabled:{" "}
                  {disabledCount}
                </span>
              </div>
