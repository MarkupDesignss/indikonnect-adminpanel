          ...
          <form onSubmit={handleSubmit}>
            <div className="max-h-[75vh] overflow-y-auto bg-[#FAFBFA] p-5 sm:p-6">
              ...
              <div className="rounded-[18px] border border-[#163F20]/12 bg-[#FAFBFA] p-4 sm:p-5">
                ...
                {/* ONLY TITLE (no status, no sort order) */}
              ...
              <div className="mt-5">
                ...
                <div className="mt-4 flex justify-center">
                  <button
                    type="button"
                    onClick={addBlock}
                    className="flex h-11 items-center justify-center gap-2 rounded-xl border border-[#163F20]/20 bg-[#EAF3EA] px-6 text-xs font-bold text-[#163F20] transition hover:bg-[#163F20] hover:text-white"
                  >
                    <FiPlus size={15} />
                    Add Block
                  </button>
                    ...
                    (
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="mt-4 rounded-xl border border-[#163F20]/10 bg-[#F5F7F5] p-3">
                            <p className="text-[9px] font-bold uppercase tracking-wide text-[#9AA29C]">
                              Latest Version
                            </p>
